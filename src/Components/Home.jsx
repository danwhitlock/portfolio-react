        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-32 lg:py-32">
          <div className="text-center justify-items-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              I'm a Front-End Developer with a background in Art & Design,
              passionate about web design and functionality. I'm also a
              qualified Scrum Master & Project Manager with over a decade of
              experience delivering complex change programmes for clients in
              regulated environments.
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              I'm a driven learner - I believe strongly in continuous
